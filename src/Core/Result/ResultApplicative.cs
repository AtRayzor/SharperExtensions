...
/// <summary>
/// Provides applicative operations for the
/// <see cref="Result{T, TError}" /> type.
/// </summary>
public static partial class Result
{
    /// <summary>
    /// Contains applicative methods for the
    /// <see cref="Result{T, TError}" /> type.
    /// </summary>
    public static class Applicative
    {
        /// <summary>
        /// Applies a wrapped function to a wrapped value, producing a new
        /// <see cref="Result{TNew, TError}" />.
        /// </summary>
        /// <typeparam name="T">The type of the input value.</typeparam>
        /// <typeparam name="TError">The type of the error.</typeparam>
        /// <typeparam name="TNew">The type of the output value.</typeparam>
        /// <param name="result">
        /// The <see cref="Result{T, TError}" /> containing the
        /// input value.
        /// </param>
        /// <param name="wrappedMapping">
        /// The
        /// <see>
        ///     <cref>Result{Func{T, TNew}, TError}</cref>
        /// </see>
        /// containing the function to apply.
        /// </param>
        /// <returns>
        /// An <see cref="Ok{T, TError}" /> containing the result of applying the
        /// function if both inputs are <see cref="Ok{T, TError}" />, otherwise an
        /// <see cref="Error{T, TError}" /> containing the error.
        /// </returns>
        [Pure]
...
/// <summary>
/// Provides extension methods for applicative operations on
