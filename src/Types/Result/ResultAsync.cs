...
public static partial class Result
{
    public static class Async
    {
        ...
        public static async ValueTask<Result<T, TError>> AwaitIfOk<T, TError>(
            ...
            {
                Ok<ValueTask<T>, TError> okValueTask => Result<T, TError>.Ok(
                    await okValueTask.Value.ConfigureAwait(false)
                ),
                Error<ValueTask<T>, TError> error => Result<T, TError>.Error(error),
            };
        ...
        public static async Task<Result<T, TError>> AwaitIfOk<T, TError>(
            ...
            taskResult switch
            {
                Ok<Task<T>, TError> okValueTask => Result<T, TError>.Ok(
                    await okValueTask.Value.ConfigureAwait(ConfigureAwaitOptions.None)
                ),
                Error<Task<T>, TError> error => Result<T, TError>.Error(error),
            };
        ...
        public static async Task<Result<T, TError>> AwaitIfOk<T, TError>(
            ...
            where T : notnull
            where TError : notnull =>
            await (await task.ConfigureAwait(false)).AwaitIfOk().ConfigureAwait(false);
        ...
        public static async ValueTask<Result<T, TError>> AwaitIfError<T, TError>(
            ...
            valueTaskResult switch
            {
                Ok<T, ValueTask<TError>> okValue => Result<T, TError>.Ok(okValue.Value),
                Error<T, ValueTask<TError>> errorValueTask => Result<T, TError>.Error(
        ...
        public static async Task<Result<T, TError>> AwaitIfError<T, TError>(
            ...
            taskResult switch
            {
                Ok<T, Task<TError>> okValue => Result<T, TError>.Ok(okValue.Value),
                Error<T, Task<TError>> errorValueTask => Result<T, TError>.Error(
        ...
        public static async ValueTask<Result<T, TError>> AwaitIfError<T, TError>(
            ...
            where T : notnull
            where TError : notnull =>
            await (await task.ConfigureAwait(false)).AwaitIfError().ConfigureAwait(false);
        ...
        public static async ValueTask<Result<T, TError>> Await<T, TError>(
            ...
            where T : notnull
            where TError : notnull =>
            await AwaitIfError(await AwaitIfOk(valueTaskResult)).ConfigureAwait(false);
        ...
        public static async ValueTask<Result<T, TError>> Await<T, TError>(
            ...
            where T : notnull
            where TError : notnull =>
            await Await(await task.ConfigureAwait(false)).ConfigureAwait(false);
    }
}
...
public static class ResultAsyncExtensions
{
    ...
    public static ValueTask<Result<T, TError>> AwaitIfOk<T, TError>(
        ...
        where T : notnull
        where TError : notnull => Result.Async.AwaitIfOk(valueTaskResult);
    ...
    public static Task<Result<T, TError>> AwaitIfOk<T, TError>(
        ...
        where T : notnull
        where TError : notnull => Result.Async.AwaitIfOk(task);
    ...
    public static Task<Result<T, TError>> AwaitIfOk<T, TError>(
        ...
        where T : notnull
        where TError : notnull => Result.Async.AwaitIfOk(taskResult);
    ...
    public static ValueTask<Result<T, TError>> AwaitIfError<T, TError>(
        ...
        where T : notnull
        where TError : notnull => Result.Async.AwaitIfError(valueTaskResult);
    ...
    public static Task<Result<T, TError>> AwaitIfError<T, TError>(
        ...
        where T : notnull
        where TError : notnull => Result.Async.AwaitIfError(taskResult);
    ...
    public static Task<Result<T, TError>> AwaitIfError<T, TError>(
        ...
        where T : notnull
        where TError : notnull => Result.Async.AwaitIfError(task);
    ...
    public static ValueTask<Result<T, TError>> Await<T, TError>(
        ...
        where T : notnull
        where TError : notnull => Result.Async.Await(valueTaskResult);
    ...
    public static Task<Result<T, TError>> Await<T, TError>(
        ...
        where T : notnull
        where TError : notnull => Result.Async.Await(taskResult);
