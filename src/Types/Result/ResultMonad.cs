...
public static partial class Result
{
    ...
    public static class Monad
    {
        ...
        /// returning a new <see cref="Result{T, TNewError}"/>.
        /// If the input is an <see cref="Error{T, TError}"/>, applies the binder function to its error.
        /// If the input is an <see cref="Ok{T, TError}"/>, returns an <see cref="Ok{T, TNewError}"/> with the same value.
        /// </summary>
        ...
        /// <returns>A new <see cref="Result{T, TNewError}"/> after applying the binder or preserving the success value.</returns>
        [Pure]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
