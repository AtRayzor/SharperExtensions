...
public static partial class Option
{
    ...
    {
        public static T GetValueOrThrow<T, TException>(Option<T> option, params object[] constructorArgs)
            where T : notnull where TException : Exception =>
            GetValueOrThrowRequestedException<T, TException>(option, constructorArgs);

        public static void DoOrThrow<T, TException>(Option<T> option, Action<T> action,
            params object[] constructorArgs) where T : notnull where TException : Exception =>
        ...
        private static T GetValueOrThrowRequestedException<T, TException>(
            ...
            where T : notnull where TException : Exception
        {
            var activatedException = ExceptionHelpers.TryToConstructException<TException>(constructorArgs);
...
public static class OptionExceptionExtensions
{
    ...
    public static T GetValueOrThrow<T, TException>(this Option<T> option, params object[] constructorArgs)
        where T : notnull where TException : Exception =>
        Option.Unsafe.GetValueOrThrow<T, TException>(option, constructorArgs);

    public static void DoOrThrow<T, TException>(this Option<T> option, Action<T> action,
