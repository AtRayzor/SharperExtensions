    ...
    public async Task SuppressesWhenCasesExhaustive()
    {
        ...
        context.TestState.Sources.AddRange(
            [
                ...
                ("ClosedTestType.cs", SourceTextFactory.CreateSourceText("../../../TestSources/ClosedTestType.cs")),
                ("GenericClosedTestType.cs",
                    SourceTextFactory.CreateSourceText("../../../TestSources/GenericClosedTestType.cs")),
            ]
        );
