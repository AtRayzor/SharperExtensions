...
public class SideEffectsTests
{
    ...
    {
        SomeOptionWithSideEffects
            .Invoking(o => o.ThrowIfNone<DummyValue, InvalidDataException>())
            .Should()
    ...
    {
        NoneOptionWithSideEffects
            .Invoking(o => o.ThrowIfNone<DummyValue, InvalidDataException>("exception thrown"))
            .Should()
    ...
    {
        NoneOptionWithSideEffects
            .Invoking(o => o.GetValueOrThrow<DummyValue, InvalidDataException>())
            .Should()
            .Throw<InvalidDataException>();
    }
    ...
    public void DoOrThrow_CalledOnSome_ActionExecuted()
    {
        SomeOptionWithSideEffects
            .Invoking(o =>
            {
                ...
                o.DoOrThrow<DummyValue, InvalidDataException>(value => nullableName = value.Name);
