...
{
    public static readonly DummyValue Value = new() { Name = "Jack Black", Email = "jack.black@example.com" };
    ...
    public static readonly DummyNewError NewError = new() { Message = "new error message", Count = 2 };
}
