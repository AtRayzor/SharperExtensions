...
public class ResultAsync
{
    ...
    public async Task TestAwaitIfOk_ValueTask()
    {
        ...
        var valueTasKResult = Result<ValueTask<DummyValue>, DummyError>
            .Ok(ValueTask.FromResult(ResultTestData.Value));
    ...
    {
        var expected = Result<DummyValue, DummyError>.Ok(ResultTestData.Value);
        var valueTasKResult = Result<Task<DummyValue>, DummyError>
            .Ok(Task.FromResult(ResultTestData.Value));
    ...
    public async Task TestAwaitIfError_ValueTask()
    {
        ...
        var valueTasKResult = Result<DummyValue, ValueTask<DummyError>>
            .Error(ValueTask.FromResult(ResultTestData.Error));
    ...
    {
        var expected = Result<DummyValue, DummyError>.Error(ResultTestData.Error);
        var valueTasKResult = Result<DummyValue,Task<DummyError>>
            .Error(Task.FromResult(ResultTestData.Error));
