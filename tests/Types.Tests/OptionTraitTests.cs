...
public class OptionTraitTests
{
    ...
    {
        SomeOptionFunctor.AsOption().Should().BeAssignableTo<IOption<DummyValue>>();
    }
    ...
    public void AsFunctor_CallOnFunctor_ConvertToOption()
    {
        ...
        someOption.AsFunctor().Should().BeAssignableTo<IFunctor<OptionType<DummyValue>>>();
    }

    [Fact]
    public void AsMonad_CallOnFunctor_ConvertToOption()
    {
        SomeOptionFunctor.AsMonad().Should().BeAssignableTo<IMonad<OptionType<DummyValue>>>();
    }
