...
public class ResultTests
{
    ...
    public void Combine_FirstOk_SecondError_ShouldReturnError()
    {
        ...
        var expected =
            Result.Error<(DummyValue, DummyNewValue), DummyError>(ResultTestData.Error);
    ...
    public void Combine_BothError_ShouldReturnError()
    {
        ...
        var expected = Result.Error<(DummyValue, DummyNewValue), DummyError>(
            new DummyError
            {
                Message = ResultTestData.DefaultError.Message
                          + ResultTestData.Error.Message,
            }
        );
    ...
    public void Unsafe_GetValueOrDefault_ReturnsValueOrDefault()
    {
        ...
        Result
            .Unsafe
            .GetValueOrDefault(ok, ResultTestData.DefaultValue)
            .Should()
            .Be(ResultTestData.Value);
        Result
            .Unsafe
            .GetValueOrDefault(error, ResultTestData.DefaultValue)
            .Should()
    ...
    public void Unsafe_GetErrorOrDefault_ReturnsErrorOrDefault()
    {
        ...
        Result
            .Unsafe
            .GetErrorOrDefault(error, ResultTestData.DefaultError)
            .Should()
            .Be(ResultTestData.Error);
        Result
            .Unsafe
            .GetErrorOrDefault(ok, ResultTestData.DefaultError)
            .Should()
