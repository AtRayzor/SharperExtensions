...
public class OptionApplicativeTests
{
    ...
    {
        ((await TestData.ValueOptionApplicativeAsync.ApplyAsync(TestData.SomeApplicativeMappingAsync)).Type
                as OptionType<DummyNewValue>.Some)
            .Should()
            .BeEquivalentTo(TestData.NewValueOption);
    }
    ...
    {
        ((await TestData.ValueOptionApplicativeAsync.ApplyAsync(TestData.NoneApplicativeMappingAsync)).Type
                as OptionType<DummyNewValue>.None)
            .Should()
            .NotBeNull();
    }
    ...
    {
        ((await TestData.NoneOptionApplicativeAsync.ApplyAsync(TestData.SomeApplicativeMappingAsync)).Type
                as OptionType<DummyNewValue>.None)
            .Should()
            .NotBeNull();
    }
    ...
    {
        ((await TestData.NoneOptionApplicativeAsync.ApplyAsync(TestData.NoneApplicativeMappingAsync)).Type
                as OptionType<DummyNewValue>.None)
            .Should()
            .NotBeNull();
    }
...
file static class TestData
{
    ...
    public static IApplicative<OptionType<Func<DummyValue, DummyNewValue>>> SomeApplicativeMapping =>
    ...
    public static IApplicative<OptionType<Func<DummyValue, DummyNewValue>>> NoneApplicativeMapping =>
        new Applicative<OptionType<Func<DummyValue, DummyNewValue>>>(
    ...
    public static Task<IApplicative<OptionType<Func<DummyValue, DummyNewValue>>>> SomeApplicativeMappingAsync =>
        Task.FromResult(SomeApplicativeMapping);

    public static Task<IApplicative<OptionType<Func<DummyValue, DummyNewValue>>>> NoneApplicativeMappingAsync =>
        Task.FromResult(NoneApplicativeMapping);
}
