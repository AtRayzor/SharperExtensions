...
public class ResultApplicativeTests
{
    ...
    {
        ((await TestData.ValueResulApplicativeAsync.ApplyAsync(TestData.OkApplicativeMappingAsync)).Type
                as ResultType<DummyNewValue, DummyError>.Ok)
            .Should()
            .BeEquivalentTo(TestData.NewValueResult);
    }
    ...
    {
        ((await TestData.ValueResulApplicativeAsync.ApplyAsync(TestData.ErrorApplicativeMappingAsync)).Type
                as ResultType<DummyNewValue, DummyError>.Error)
            .Should()
            .BeEquivalentTo(TestData.NewMappingErrorResult);
    }
    ...
    {
        ((await TestData.ErrorResultApplicativeAsync.ApplyAsync(TestData.OkApplicativeMappingAsync)).Type
                as ResultType<DummyNewValue, DummyError>.Error)
            .Should()
            .BeEquivalentTo(TestData.NewErrorResult);
    }
    ...
    {
        ((await TestData.ErrorResultApplicativeAsync.ApplyAsync(TestData.ErrorApplicativeMappingAsync)).Type
                as ResultType<DummyNewValue, DummyError>.Error)
            .Should()
            .BeEquivalentTo(TestData.NewMappingErrorResult);
    }
...
file static class TestData
{
    ...
    public static ResultType<DummyValue, DummyError>.Ok ValueResult => new ResultType<DummyValue, DummyError>.Ok(Value);

    public static ResultType<DummyValue, DummyError>.Error ErrorResult =>
    ...
    public static ResultType<DummyNewValue, DummyError>.Error NewMappingErrorResult => new(MappingError);

    public static IApplicative<ResultType<DummyValue, DummyError>> ValueResulApplicative =>
        new Applicative<ResultType<DummyValue, DummyError>>(new ResultType<DummyValue, DummyError>.Ok(Value));

    public static IApplicative<ResultType<DummyValue, DummyError>>
        ErrorResultApplicative =>
        new Applicative<ResultType<DummyValue, DummyError>>(new ResultType<DummyValue, DummyError>.Error(Error));

    public static IApplicative<ResultType<Func<DummyValue, DummyNewValue>, DummyError>> OkApplicativeMapping =>
    ...
    public static IApplicative<ResultType<Func<DummyValue, DummyNewValue>, DummyError>> ErrorApplicativeMapping =>
        new Result<Func<DummyValue, DummyNewValue>, DummyError>(
            new ResultType<Func<DummyValue, DummyNewValue>, DummyError>.Error(
                TestData.MappingError
            )
        );

    public static Task<IApplicative<ResultType<DummyValue, DummyError>>> ValueResulApplicativeAsync =>
        Task.FromResult(ValueResulApplicative);

    public static Task<IApplicative<ResultType<DummyValue, DummyError>>>
        ErrorResultApplicativeAsync => Task.FromResult(ErrorResultApplicative);

    public static Task<IApplicative<ResultType<Func<DummyValue, DummyNewValue>, DummyError>>>
        OkApplicativeMappingAsync =>
        Task.FromResult(OkApplicativeMapping);

    public static Task<IApplicative<ResultType<Func<DummyValue, DummyNewValue>, DummyError>>>
        ErrorApplicativeMappingAsync =>
        Task.FromResult(ErrorApplicativeMapping);
}
